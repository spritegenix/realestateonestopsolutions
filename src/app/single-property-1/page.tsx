                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12">
                        <div className="property_block_wrap style-2 p-4">
                            <div className="prt-detail-title-desc">
                                ...
                                <h3 className='mt-3'>Shanti Nivas: Your Peaceful Abode in Mumbai</h3>
                                <span><i className="lni-map-marker"></i> Bandra West, Mumbai, Maharashtra</span>
                                <h3 className="prt-price-fix text-primary mt-2">₹1,50,000<sub>/month</sub></h3>
